    ...
    function TransformTool() {
        ...
        function onTxChange() {
            ...
            for(var fragId in _selectedFragProxyMap) {
                ...
                fragProxy.matrixWorld.setPosition(position);
            }
        ...
        function onItemSelected(event) {
            ...
            if(_hitPoint) {
                ...
                event.fragIdsArray.forEach(function (fragId) {
                    ...
                    var fragProxy = viewer.impl.getRenderProxy(
                      viewer,
                      fragId);

                    var position = getMeshPosition(fragProxy);

                    var offset = {

                        x: _hitPoint.x - position.x,
                        y: _hitPoint.y - position.y,
                        z: _hitPoint.z - position.z
                    };
